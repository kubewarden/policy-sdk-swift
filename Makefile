...
CONTAINER_IMAGE := "ghcr.io/kubewarden/swift-wasm-runner:5.3"
...
containerized-docs:
	$(CONTAINER_RUNTIME) run -ti --rm -v $(PWD):/code swiftdoc/swift-doc:1.0.0-rc.1 generate /code --module-name "Kubewarden SDK" --format html --output /code/docs
